...
var __glue_Vanilla_textRenderer_getWidth: (String) -> Int = { _: String ->
    org.anti_ad.mc.sbt.common.Log.error("__glue_Vanilla_textRenderer_getWidth not initialized!")
    100
}

var __glue_Vanilla_textRenderer_drawWithShadow: (String, Double, Double, Int) -> Unit = {_: String, _: Double, _: Double, _: Int ->
    org.anti_ad.mc.sbt.common.Log.error("__glue_Vanilla_textRenderer_drawWithShadow not initialized!")
}

var __glue_Vanilla_textRenderer_draw: (String, Double, Double, Int) -> Unit = {_: String, _: Double, _: Double, _: Int ->
    org.anti_ad.mc.sbt.common.Log.error("__glue_Vanilla_textRenderer_draw not initialized!")
}
...
var __glue_Vanilla_textRenderer_textHandler_wrapLines: (String, Int) -> String = { s: String, _: Int ->
    org.anti_ad.mc.sbt.common.Log.error("glue__Vanilla_textRenderer_textHandler_wrapLines not initialized!")
    s
}
