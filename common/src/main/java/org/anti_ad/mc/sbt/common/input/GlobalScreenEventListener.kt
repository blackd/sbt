package org.anti_ad.mc.sbt.common.input

import org.anti_ad.mc.sbt.common.ScreenEventListener
import org.anti_ad.mc.sbt.common.vanilla.glue.VanillaUtil

object GlobalScreenEventListener {
    private val registeredPre = mutableSetOf<org.anti_ad.mc.sbt.common.ScreenEventListener>()
    private val registeredPost = mutableSetOf<org.anti_ad.mc.sbt.common.ScreenEventListener>()

    fun registerPre(listener: org.anti_ad.mc.sbt.common.ScreenEventListener) = registeredPre.add(listener)
    fun unregisterPre(listener: org.anti_ad.mc.sbt.common.ScreenEventListener) = registeredPre.remove(listener)

    fun registerPost(listener: org.anti_ad.mc.sbt.common.ScreenEventListener) = registeredPost.add(listener)
    fun unregisterPost(listener: org.anti_ad.mc.sbt.common.ScreenEventListener) = registeredPost.remove(listener)
    ...
    private inline fun any(pre: Boolean,
                           predicate: (org.anti_ad.mc.sbt.common.ScreenEventListener) -> Boolean): Boolean {
