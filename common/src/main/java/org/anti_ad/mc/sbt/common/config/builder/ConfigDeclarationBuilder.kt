...
import org.anti_ad.mc.sbt.common.config.options.*
import org.anti_ad.mc.sbt.common.config.toMultiConfig
import org.anti_ad.mc.sbt.common.extensions.ByPropertyName
import org.anti_ad.mc.sbt.common.gui.widgets.ConfigButtonInfo
import org.anti_ad.mc.sbt.common.input.KeybindSettings
import org.anti_ad.mc.sbt.common.input.KeybindSettings.Companion.INGAME_DEFAULT
...
fun ConfigDeclaration.hotkeyedBool(defaultValue: Boolean) =
    org.anti_ad.mc.sbt.common.config.options.ConfigHotkeyedBoolean(defaultValue).addTo(this)
