...
import org.anti_ad.mc.sbt.common.TellPlayer
...
private val configFolder = VanillaUtil.configDirectory("smallbuildtweaks")
...
object OpenConfigFolderButtonInfo : ConfigButtonInfo() {
    override val buttonText: String
        get() = I18n.translate("smallbuildtweaks.gui.config.button.open_config_folder")
...
object OpenProfilesHelpButtonInfo : ConfigButtonInfo() {
    override val buttonText: String
        get() = I18n.translate("smallbuildtweaks.gui.config.profiles_help_button")
...
object OpenProfilesConfigButtonInfo : ConfigButtonInfo() {
    override val buttonText: String
        get() = I18n.translate("smallbuildtweaks.gui.config.profiles_config_button")
