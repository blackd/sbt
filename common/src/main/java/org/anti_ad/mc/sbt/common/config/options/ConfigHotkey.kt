...
import org.anti_ad.mc.sbt.common.config.toJsonArray
import org.anti_ad.mc.sbt.common.input.AlternativeKeybind
import org.anti_ad.mc.sbt.common.input.KeybindSettings
import org.anti_ad.mc.sbt.common.input.MainKeybind
...
class ConfigHotkey(defaultStorageString: String,
    ...
    override fun fromJsonObject(obj: JsonObject) {
        try {
            ...
            org.anti_ad.mc.sbt.common.Log.warn("Failed to read JSON element '${obj["alternatives"]}' as a JSON array")
        }
    }
