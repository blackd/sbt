...
import org.anti_ad.mc.sbt.common.gui.widget.Axis
import org.anti_ad.mc.sbt.common.gui.widget.BiFlex
...
abstract class ConfigWidgetBase<out T : IConfigOption>(val configOption: T) : FlexWidgetBase() {
    ...
    val resetButton = ButtonWidget { -> reset() }.apply {
        text = I18n.translate("smallbuildtweaks.common.gui.config.reset")
    }
...
class ConfigBooleanWidget(configOption: ConfigBoolean) : ConfigWidgetBase<ConfigBoolean>(configOption) {
    var trueText = I18n.translate("smallbuildtweaks.common.gui.config.true")
    var falseText = I18n.translate("smallbuildtweaks.common.gui.config.false")
