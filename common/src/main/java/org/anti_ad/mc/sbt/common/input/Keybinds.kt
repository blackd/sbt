...
import org.anti_ad.mc.sbt.common.config.IConfigElementObject
import org.anti_ad.mc.sbt.common.input.KeybindSettings.ModifierKey.DIFFERENTIATE
...
interface IKeybind : IConfigElementObject {
    ...
    override fun fromJsonObject(obj: JsonObject) {
        try {
            ...
            org.anti_ad.mc.sbt.common.Log.warn("Failed to set config value for 'keys' from the JSON element '${obj["keys"]}'")
        }
    }
