...
import org.anti_ad.mc.sbt.common.math2d.*
import org.anti_ad.mc.sbt.common.math2d.Corner.*
...
var __glue_make_Identifier: (String, String) -> Any = { _: String, _: String ->
    org.anti_ad.mc.sbt.common.Log.error("__glue_make_Identifier not initialized! This hard breaks stuff!")
...
var __glue_rBlit: (x: Int, y: Int, w: Int, h: Int, sx: Int, sy: Int, sw: Int, sh: Int, tw: Int, th: Int) -> Unit = {
    ...
    org.anti_ad.mc.sbt.common.Log.error("__glue_rBlit not initialized! This hard breaks stuff!")
    throw UninitializedPropertyAccessException("__glue_make_Identifier not initialized! This hard breaks stuff!")
}
...
var __glue_rDrawDynamicSizeSprite: (sprite: DynamicSizeSprite,
    ...
    { _: DynamicSizeSprite, _: Rectangle, _: DynamicSizeMode ->
        org.anti_ad.mc.sbt.common.Log.error("__glue_rDrawDynamicSizeSprite not initialized! This hard breaks stuff!")
        throw UninitializedPropertyAccessException("__glue_make_Identifier not initialized! This hard breaks stuff!")
    }

var __glue___glue_VANILLA_TEXTURE_WIDGETS_Sprite: () -> Sprite = {
    org.anti_ad.mc.sbt.common.Log.error("__glue___glue_VANILLA_TEXTURE_WIDGETS_Sprite not initialized! This hard breaks stuff!")
