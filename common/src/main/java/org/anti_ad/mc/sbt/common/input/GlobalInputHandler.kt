...
import org.anti_ad.mc.sbt.common.gui.debug.DebugInfos
...
object GlobalInputHandler {
    ...
    // api
    // ============
    private val registered: MutableSet<org.anti_ad.mc.sbt.common.IInputHandler> = mutableSetOf()
    private val registeredCancellable: MutableSet<org.anti_ad.mc.sbt.common.IInputHandler> = mutableSetOf() // screen only

    fun register(inputHandler: org.anti_ad.mc.sbt.common.IInputHandler): Boolean =
        registered.add(inputHandler)

    fun unregister(inputHandler: org.anti_ad.mc.sbt.common.IInputHandler): Boolean =
        registered.remove(inputHandler)

    fun registerCancellable(inputHandler: org.anti_ad.mc.sbt.common.IInputHandler): Boolean =
        registeredCancellable.add(inputHandler)

    fun unregisterCancellable(inputHandler: org.anti_ad.mc.sbt.common.IInputHandler): Boolean =
