...
import org.anti_ad.mc.sbt.common.config.IConfigElementResettableMultiple
import org.anti_ad.mc.sbt.common.config.options.ConfigBoolean
import org.anti_ad.mc.sbt.common.config.options.ConfigEnum
import org.anti_ad.mc.sbt.common.extensions.containsAny
import org.anti_ad.mc.sbt.common.input.KeybindSettings.Context.*
import org.anti_ad.mc.sbt.common.input.KeybindSettings.KeyAction.PRESS
import org.anti_ad.mc.sbt.common.input.KeybindSettings.ModifierKey.NORMAL
...
data class KeybindSettings(val context: Context,
    ...
    enum class KeyAction {
        ...
        override fun toString(): String {
            return I18n.translate("smallbuildtweaks.common.enum.key_action." + name.toLowerCase())
        }
    }
    ...
    enum class Context {
        ...
        override fun toString(): String {
            return I18n.translate("smallbuildtweaks.common.enum.context." + name.toLowerCase())
        }
    }
    ...
    enum class ModifierKey {
        ...
        override fun toString(): String {
            return I18n.translate("smallbuildtweaks.common.enum.modifier_key." + name.toLowerCase())
        }
    }
