...
import org.anti_ad.mc.sbt.common.gui.widgets.TextButtonWidget
import org.anti_ad.mc.sbt.common.gui.widgets.toConfigWidget
import org.anti_ad.mc.sbt.common.input.ConfigKeybindSettings
...
class ConfigOptionHotkeyDialog(val configHotkey: ConfigHotkey) :
    BaseDialog(Text.translatable("smallbuildtweaks.common.gui.config.advanced_keybind_settings")) {
