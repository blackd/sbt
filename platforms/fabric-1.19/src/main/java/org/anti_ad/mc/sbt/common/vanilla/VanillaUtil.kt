...
import org.anti_ad.mc.sbt.common.extensions.createDirectories
import org.anti_ad.mc.sbt.common.extensions.div
import org.anti_ad.mc.sbt.common.extensions.pathFrom
import org.anti_ad.mc.sbt.common.extensions.readToString
...
import org.anti_ad.mc.sbt.common.vanilla.alias.Util
import org.anti_ad.mc.sbt.common.vanilla.glue.IVanillaUtil
import org.anti_ad.mc.sbt.common.vanilla.glue.__glue_vanillaUtil
import org.anti_ad.mc.sbt.common.vanilla.render.glue.glue_rScreenHeight
...
//  }
    ...
    override fun getResourceAsString(identifier: String): String? = tryCatch {
        Vanilla.resourceManager().getResource(Identifier(identifier)).get().inputStream?.readToString()
    }
    ...
    override fun chat(message: String) = Vanilla.chatHud().addMessage(Text.literal(message))
}
